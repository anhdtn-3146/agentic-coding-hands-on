...
export const metadata: Metadata = {
  title: "Sự kiện sẽ bắt đầu sau — Sun* Annual Awards 2025",
  description:
    "Trang đếm ngược prelaunch Sun* Annual Awards 2025 — sự kiện sẽ sớm bắt đầu.",
};
...
export default function CountdownPage() {
  return (
    <main
      className={`${montserrat.variable} relative min-h-screen w-full overflow-hidden bg-[#00101A]`}
    >
      {/* mm:2268:35129 MM_MEDIA_BG Image — full-bleed background artwork */}
      <Image
        src="/countdown/countdown-bg.png"
        alt=""
        fill
        priority
        sizes="100vw"
      ...
      {/* mm:2268:35131 Bìa — countdown block centered over the artwork */}

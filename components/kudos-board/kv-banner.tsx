...
export default function KvBanner() {
  ...
  return (
    // mm:2940:13437
    <section
      className="relative h-[512px] w-full overflow-hidden bg-[#00101A]"
      aria-label={t("kudosBoard:kvBanner.title")}
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1152px] flex-col items-start gap-[10px] px-6 pt-[184px] lg:px-0">
        {/* mm:2940:13438 Group 424 */}
        <h1 className="font-(family-name:--font-montserrat) text-2xl leading-[44px] font-bold text-[#FFEA9E] sm:text-3xl lg:text-[36px]">

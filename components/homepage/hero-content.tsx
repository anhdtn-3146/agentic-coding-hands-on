...
export default function HeroContent() {
  ...
  return (
    // mm:3204:10152
    <div className="flex w-full max-w-[1152px] flex-col items-center gap-8 rounded-lg px-4 py-16 font-(family-name:--font-montserrat) text-white sm:px-10 lg:py-[120px]">
      {/* mm:3204:10153 Group 434 — stacked ROOT / FURTHER wordmark */}
      <div className="relative h-[102px] w-[220px] sm:h-[134px] sm:w-[290px]">
      ...
      {/* mm:3204:10156 */}
      <p className="w-full text-justify text-[24px] leading-[32px] font-bold whitespace-pre-line">
        {t("home:hero.content.intro")}
      </p>

      {/* mm:3204:10161 */}
      <p className="w-full text-center text-[20px] leading-[32px] font-bold whitespace-pre-line">

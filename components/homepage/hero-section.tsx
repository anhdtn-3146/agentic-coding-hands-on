...
export default function HeroSection() {
  ...
  return (
    // mm:2167:9030
    <section
      className={`${montserrat.variable} relative w-full overflow-hidden bg-[#00101A]`}
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1224px] flex-col items-center gap-16 px-6 pt-[184px] pb-12 sm:px-10 lg:gap-[120px] lg:px-0 lg:pb-24">

...
export default function SunkudosSection() {
  ...
  return (
    ...
    <section
      className={`${montserrat.className} mx-auto w-full max-w-[1224px]`}
    >
      ...
      <div className="relative aspect-[1120/500] w-full overflow-hidden rounded-2xl bg-[#00101A]">
        ...
        >
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <p className="text-2xl font-bold leading-8 text-white">
              {t("common:kudos.kicker")}
            </p>
            {/* mm:I3390:10349;313:8422 */}
            <p className="text-[57px] font-bold leading-[64px] tracking-[-0.25px] text-[#FFEA9E]">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <Link
              href="/sun-kudos"
              className="flex items-center gap-2 rounded bg-[#FFEA9E] px-4 py-4 text-[#00101A]"
            >
        ...
        <div
          className="absolute aspect-[364/72]"
          style={{ left: "60%", top: "43%", width: "32.5%" }}
        >
          <Image
            src="/icons/logo_kudos.svg"
            alt="Sun* Kudos"
            fill
            sizes="364px"

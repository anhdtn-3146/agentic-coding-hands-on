...
export default function AwardSection() {
  ...
  return (
    // mm:2167:9068
    <section className="mx-auto flex w-full max-w-[1224px] flex-col items-start gap-20">
      ...
      <div className="flex w-full flex-col items-start gap-4">
        ...
        <div className="flex w-full flex-row items-center gap-8">
          {/* mm:2167:9073 */}
          <h2 className="font-(family-name:--font-montserrat) text-[57px] leading-[64px] font-bold tracking-[-0.25px] text-[#FFEA9E]">
            {t("home:awards.title")}
          </h2>
        </div>
      </div>

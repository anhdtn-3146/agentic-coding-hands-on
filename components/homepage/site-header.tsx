...
export default function SiteHeader() {
  return (
    // mm:2167:9091
    <header
      className={`${montserrat.className} fixed inset-x-0 top-0 z-20 h-20 bg-[#101417]/80 py-3`}
    >
      <div className="mx-auto flex h-full w-full max-w-[1224px] items-center justify-between">
        {/* mm:I2167:9091;186:2166 */}
        <div className="flex items-center gap-16">
          {/* mm:I2167:9091;178:1033 */}
          <Link href="/about" aria-label="Sun* Annual Awards 2025 home">
            <Image
              src="/homepage-saa/Header_Logo.png"

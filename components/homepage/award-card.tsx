 ...
 * description + "Chi tiết" link with an up-arrow icon.
 *
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col items-start gap-1">
        {/* mm:214:1021 */}
        <h3 className="font-(family-name:--font-montserrat) text-2xl leading-8 font-normal text-[#FFEA9E]">
          {title}
        </h3>
        {/* mm:214:1022 */}
        <p className="font-(family-name:--font-montserrat) w-full text-base leading-6 font-normal tracking-[0.5px] text-white">
          {description}
        </p>
        {/* mm:214:1023 Button-IC */}
        <span className="flex items-center gap-1 py-4 text-white">
          <span className="font-(family-name:--font-montserrat) text-center text-base leading-6 font-medium tracking-[0.15px] whitespace-nowrap">

      ...
      {CATEGORIES.map(({ id }) => {
        ...
        return (
          <a
            ...
            className={`font-(family-name:--font-montserrat) flex max-w-44 items-center gap-1 p-4 text-sm leading-5 font-bold tracking-[0.25px] transition-colors duration-200 ${
              isActive

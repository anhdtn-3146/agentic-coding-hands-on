  ...
  return (
    ...
    <div className="relative w-full overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "url(/homepage-saa/Keyvisual_BG.png) -0.163px -858.967px / 101.245% 367.889% no-repeat",
        }}
      />
      ...
      <div className="absolute inset-0 mx-auto flex w-full max-w-[1440px] flex-col gap-30 px-36 pt-44 pb-11">
        ...
        <Image
          ...
          height={150}
          priority
          className="h-auto w-[169px] sm:w-[220px] lg:w-[338px]"
        />
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          {/* mm:313:8457 */}
          <h1 className="font-(family-name:--font-montserrat) text-[57px] leading-[64px] font-bold tracking-[-0.25px] text-[#FFEA9E]">

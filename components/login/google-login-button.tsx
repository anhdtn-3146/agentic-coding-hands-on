...
export default function GoogleLoginButton({
  ...
  return (
    <button
      ...
      disabled={loading}
      aria-busy={loading}
      className={`inline-flex items-center gap-2 rounded-lg bg-[#FFEA9E] px-4 py-3 shadow-md transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(255,234,158,0.45)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FFEA9E] disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:translate-y-0 disabled:hover:shadow-md sm:px-6 sm:py-4 ${className}`}
    >
      <span className="font-(family-name:--font-montserrat) text-base font-bold leading-6 text-[#00101A] sm:text-[22px] sm:leading-7">

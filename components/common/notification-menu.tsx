  ...
  return (
    ...
    <div ref={containerRef} className="relative">
      <button
        ...
        className="relative flex h-10 w-10 items-center justify-center rounded p-2.5 text-white transition-colors duration-200 hover:bg-white/10"
      >
        <IconBell className="h-6 w-6" aria-hidden="true" />
        {/* mm:I2167:9091;186:2101;186:2089 */}
        <span
          aria-hidden="true"
          className="absolute top-[9px] right-[9px] h-2 w-2 rounded-full bg-[#D4271D]"
        />
      </button>
